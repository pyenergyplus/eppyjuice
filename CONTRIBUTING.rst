...
- *Contributer*: pull the changes from pyenergyplus/eppyjuice *Maintainer* has completed the merge
    ...
    - To do the above you need a remote called `upstream`. You can set this up by the following line in the command line
      ::
        ...
        git remote add upstream https://github.com/pyenergyplus/eppyjuice.git
